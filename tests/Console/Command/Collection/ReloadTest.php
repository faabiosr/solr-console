...
class ReloadTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\Solr\Console\Command\Collection\Command', new Reload());
    }
    ...
    {
        $tester = new CommandTester(new Reload());
        $tester->execute([]);
    }
    ...
    public function testShouldExecuteCommand()
    {
        ...
        $this->assertRegExp('/The collection was reloaded/', $tester->getDisplay());
